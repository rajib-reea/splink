...
7. [Clustering](clustering/clustering_overview.md) - for guidance on how records are clustered together, including information on blocking, scoring, and the clustering process.
